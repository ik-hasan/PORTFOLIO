  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
        {/* left side contetnt */}
        <div className="md:w-1/2 mb-10 md:ml-25 md:mb-0">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            Hi, I'm <span className="text-purple">Ikramul Hasan</span>
          </h1>
        ...
        <div className="md:w-1/2 flex justify-center">
          <div className="relative w-64 h-64 md:w-80 md:h-80">
            <div className="absolute insert-0 rounded-full bg-gradient-to-r from-purple to-pink opacity-90">
              <motion.img
                animate={{y:[0,-20,0]}}
                transition={{
                  duration:4,
                ...
                className="relative rounded-full w-64 h-64 md:w-80 md:h-80 object-cover z-10" src={assets.profileImg} alt=""
              />
            </div>
          </div>
